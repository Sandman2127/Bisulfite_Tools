...
/mnt/ws/home/dsanders/Data/bsmap-2.90/samtools/samtools view -bS $1 > $tmpbam
if [ $? -ne 0 ]; then
...
echo "Sorting BAM ..."
/mnt/ws/home/dsanders/Data/bsmap-2.90/samtools/samtools sort $tmpbam ${outbam%.*}
if [ $? -ne 0 ]; then
...
rm $tmpbam
echo "Indexing BAM ..."
/mnt/ws/home/dsanders/Data/bsmap-2.90/samtools/samtools index $outbam
if [ $? -ne 0 ]; then
